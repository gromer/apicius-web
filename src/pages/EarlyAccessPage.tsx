...
export function EarlyAccessPage() {
  ...
  const handleEarlyAccessRequestSubmission = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Failed to submit early access request. Please try again.');
    } finally {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-md mx-auto">
            ...
            <p className="mt-4 text-lg text-gray-500 dark:text-gray-400 text-center">
              Join our early access program and be among the first to experience Apicius.
            </p>
            ...
            {submitted ? (
              <div className="mt-8 bg-green-50 dark:bg-green-900/50 rounded-lg p-4">
                <p className="text-sm text-green-700 dark:text-green-200 text-center">
                  Thanks for your interest! We'll be in touch soon with your early access invitation.
                </p>
              </div>
            ) : (
